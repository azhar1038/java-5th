...
public class Client{
    public static void main(String[] args) throws IOException{
        ...
        String req="", res="";
        System.out.println("SUM OF PRODUCT OF CONSECUTIVE PRIME NUMBERS");
        while(true){
            System.out.print("Enter a Number: ");
            try{
                req = Integer.toString(sc.nextInt());
            }catch(Exception e){
                req = "Bye";
            }
            dsout.writeUTF(req);
            dsout.flush();
            res = dsin.readUTF();
            System.out.println(s.getRemoteSocketAddress()+" : Sum of product of consecutive prime numbers of "+req+" is "+res);
